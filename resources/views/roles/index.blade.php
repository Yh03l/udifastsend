        ...
        <div class="row">
            <div class="col-lg-12 margin-tb mb-2">
                <div class="pull-right">
                    <a class="btn btn-one" href="{{ route('roles.create') }}"> Crear nuevo Rol </a>
                </div>
            </div>
        </div>
    @endcan
                ...
                <tbody>
                    @foreach ($roles as $key => $role)
                        <tr>
                            ...
                            <td>
                                @can('rol-leer')
                                    <a class="btn btn-info" href="{{ route('roles.show', $role->id) }}" title="Detalle"><i
                                            class="fa-regular fa-eye"></i></a>
                                @endcan

                                @can('rol-editar')
                                    <a class="btn btn-primary" href="{{ route('roles.edit', $role->id) }}" title="Editar"><i
