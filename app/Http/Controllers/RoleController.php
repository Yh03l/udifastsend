...
class RoleController extends Controller
{
    ...
    {
        $this->middleware('permission:rol-listar|rol-crear|rol-leer|rol-editar|rol-eliminar', ['only' => ['index', 'show', 'store']]);
        $this->middleware('permission:rol-crear', ['only' => ['create', 'store']]);
        $this->middleware('permission:rol-leer', ['only' => ['show']]);
