...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sucursales', function (Blueprint $table) {
            ...
            $table->foreign('id_ciudad')->references('id')->on('ciudades')->onUpdate('no action')->onDelete('no action');
            $table->foreign('id_empresa')->references('id')->on('empresas')->onUpdate('no action')->onDelete('no action');
